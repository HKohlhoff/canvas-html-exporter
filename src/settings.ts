...
export class Canvas2HtmlSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    introEl.textContent = "Exports the active canvas either as a portable package folder or as a single self-contained HTML file.";
    introEl.style.marginLeft = "var(--size-4-4)";
    (containerEl as unknown as HTMLElement).appendChild(introEl);
