...
- **Clear branch size:** a collapsed branch shows its number of hidden descendant nodes. Shared descendants stay visible while another open parent branch still reaches them; the collapsed branch connection remains hidden.
