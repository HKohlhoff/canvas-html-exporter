...
- **Clear branch size:** a collapsed branch shows its number of hidden descendant nodes instead of a plus sign. Multi-digit controls grow without covering the focus control.
