# Canvas HTML Exporter 1.2.0: interactive Canvas exports
...
- **Node and branch focus:** isolate one node, one group together with its contained items, or a complete branch at full opacity while the surrounding Canvas remains visible as subdued context. Select the same focus control again or use **Exit focus** to return.
